                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  // Opens Update Stock or Reorder Screen based on item status
                                  if (item.isOutOfStock) {
                                    Navigator.push(
                                      context,
...
// -------------------------------------------------------------
// 1. ADD NEW ITEM SCREEN (Opens on '+' Floating Action Button click)
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// 2. UPDATE STOCK SCREEN (Opens on 'Update Stock' button click)
// -------------------------------------------------------------
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2), decoration: BoxDecoration(color: Colors.blue.shade100, borderRadius: BorderRadius.circular(10)), child: const Text("Current", style: TextStyle(color: Color(0xFF1D4ED8), fontSize: 10, fontWeight: FontWeight.bold))),
                      ],
                    ),
                    const SizedBox(height: 4),
                    const Text("4.5 kg", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFF1D4ED8))),
                    const SizedBox(height: 2),
                    const Text("Last updated: 2 hours ago", style: TextStyle(color: Colors.grey, fontSize: 11)),
                  ],
                ),
              ],
            ),
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: Center(child: Text("+ Add Stock", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))),
                    ),
                  ),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Container(
                      ...
                      child: Center(child: Text("- Remove / Usage", style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold))),
                    ),
                  ),
                ],
              ),
              const SizedBox(height: 16),
              const Text("Quantity", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: Colors.black54)),
              const SizedBox(height: 6),
              TextField(decoration: InputDecoration(hintText: "0.00", filled: true, fillColor: const Color(0xFFF8FAFC), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide.none))),
            ],
          ),
...
// -------------------------------------------------------------
// 3. REORDER ITEM SCREEN (Opens on 'Reorder Now' button click)
// -------------------------------------------------------------
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(10),
                  child: Image.network("https://images.unsplash.com/photo-1586201375761-83865001e31c?w=200", width: 70, height: 70, fit: BoxFit.cover),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text("GRAINS CATEGORY", style: TextStyle(color: Colors.grey, fontSize: 10, fontWeight: FontWeight.bold)),
                          Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2), decoration: BoxDecoration(color: Colors.red.shade100, borderRadius: BorderRadius.circular(10)), child: const Text("Out of Stock", style: TextStyle(color: Colors.red, fontSize: 10, fontWeight: FontWeight.bold))),
                        ],
                      ),
                      const SizedBox(height: 2),
                      const Text("Basmati Rice (Premium)", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Color(0xFF0F2C59))),
                      const SizedBox(height: 4),
                      const Text("Current Stock: 0.0 kg", style: TextStyle(color: Colors.red, fontSize: 12, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ],
          ...
          _sectionCard(
            ...
            children: [
              const Text("Quantity", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 12, color: Colors.black54)),
              const SizedBox(height: 6),
              TextField(decoration: InputDecoration(hintText: "25", filled: true, fillColor: const Color(0xFFF8FAFC), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide.none))),
            ],
          ),
          const SizedBox(height: 24),
          ElevatedButton(
            ...
            child: const Text("Place Reorder", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
      ...
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(title, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF0F2C59))),
          ],
        ),
